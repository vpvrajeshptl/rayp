...
public class CodeInmemorycacheTest {
	
		 
	    public static void main(String[] args) throws InterruptedException {
	 
	    	CodeInmemorycacheTest codecache = new CodeInmemorycacheTest();
	 
	        System.out.println("\n\n==========Test1: CodeTestAddRemoveObjects ==========");
	        codecache.CodeTestAddRemoveObjects();
	        System.out.println("\n\n==========Test2: crunchifyTestExpiredCacheObjects ==========");
	        codecache.CodeTestExpiredCacheObjects();
	        System.out.println("\n\n==========Test3: crunchifyTestObjectsCleanupTime ==========");
	        codecache.CodeTestObjectsCleanupTime();
	    }
	 
	    private void CodeTestAddRemoveObjects() {
	 
	        // Test with crunchifyTimeToLive = 200 seconds
	        // crunchifyTimerInterval = 500 seconds
	        // maxItems = 6
	        CodeInmemorycache<String, String> cache = new CodeInmemorycache<String, String>(200, 500, 6);
	    ...
	    private void CodeTestExpiredCacheObjects() throws InterruptedException {
	 
	        // Test with crunchifyTimeToLive = 1 second
	        // crunchifyTimerInterval = 1 second
	        // maxItems = 10
	    	CodeInmemorycache<String, String> cache = new CodeInmemorycache<String, String>(1, 1, 10);
	    ...
	    private void CodeTestObjectsCleanupTime() throws InterruptedException {
	        int size = 500000;
	        ...
	        CodeInmemorycache <String, String> cache = new CodeInmemorycache<String, String>(100, 100, 500000);
